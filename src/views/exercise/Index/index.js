...
const ExerciseIndexView = (props) => {
    ...
    const onRenderExerciseItem = ({ item }) => {
        return (
            <TouchableOpacity onPress={() => props.navigation.navigate('ExerciseEditView', {
                ...
                name: item.name,
                url: item.url
            })} style={{ backgroundColor: colors.background, elevation: 5, marginHorizontal: 10, paddingHorizontal: 10, paddingVertical: 15, borderRadius: 2, marginBottom: 10 }}>
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.background }}>
            ...
            <Text style={{ marginHorizontal: 20, color: colors.darkText, fontFamily: 'Montserrat-Bold', fontSize: 21, marginBottom: 20 }}>Ejercicios</Text>
            <FlatList
